...
const generos = [["rock", rock], "pop", "country"];//generos = un array y dos strings. 
...
// Ahora la banda es ["Metallica", [["rock", ["punk", "metal", "hardcore"]], "pop", "country"]]

document.write(banda[0] + ' ' + banda[1][0][1]);  // Output: "Metallica metal"
...
// It will output "false" as none of the numbers are greater than 10
...
// let p = prompt("Introduce una palabra");
// let palabras = ['tierra', 'agua', 'cielo', 'árbol', 'mesa'];
// palabras.includes(p) ? document.write("true") : document.write("false");
