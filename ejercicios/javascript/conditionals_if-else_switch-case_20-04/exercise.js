...
if ( input.toLowerCase().includes("tonto") || input.toLowerCase().includes("mierda") ||
 input.toLowerCase().includes("mamón") || input.toLowerCase().includes("hediondo") )  {
...
//- Conversiones a número mediante `parseInt`, y asegurar el uso de `===` y `!==` en las comparaciones.
alert(!true); // false
alert(!0); // true
