...
document.write(`<p>Resto división: ${b % a}</p>`);



// 2.Con las variables anterior mostrar un p indicando si a es par y si b es impar.

a % 2 === 0 ? document.write('a es par') : document.write('a es impar');
b % 2 === 0 ? document.write('b es par') : document.write('b es impar');
...
/* o así ,lo más recomendable usando CSS:

const colorA = a % 2 === 0 ? 'red' : 'green';
const colorB = b % 2 === 0 ? 'red' : 'green';
