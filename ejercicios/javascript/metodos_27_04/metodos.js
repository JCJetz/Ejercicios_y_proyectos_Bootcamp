...
let a = prompt("Escribe 'true' o 'false' para a") === 'true';
let b = prompt("Escribe 'true' o 'false' para b") === 'true';

function addBooleans(bol1, bol2) {
  return bol1 && bol2;
}

document.write(addBooleans(a, b)); // Imprime el resultado del AND de a y b
document.write('<br>');
...
// versión arrow:
// let ordenarArray = arr => arr.sort((a, b) => b - a);
...
document.write(maximo_comun(num1, num2));
document.write('<br>');
...
function fib(n) {
    ...
    for(let i=2; i<=n;i++){
        ...
        // Actualizar para la siguiente vuelta del bucle
        fib_2=fib_1;
        fib_1=fib_i;
    }
return succesion;
